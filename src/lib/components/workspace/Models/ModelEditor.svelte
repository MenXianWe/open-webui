<script lang="ts">
	...
	import { WEBUI_BRAND_LOGO_URL, DEFAULT_CAPABILITIES } from '$lib/constants';
	...
	let info = {
		...
		name: '',
		meta: {
			profile_image_url: WEBUI_BRAND_LOGO_URL,
			description: '',
							...
							<div class="self-center">
								...
								<div class="flex w-full mt-1 justify-end">
									<button
										...
										on:click={() => {
											info.meta.profile_image_url = WEBUI_BRAND_LOGO_URL;
										}}
										type="button"
									>
